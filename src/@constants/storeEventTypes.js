...
/* Compare Events */
export const FETCH_COMPARE_TOKEN = 'fetch-compare-token'
export const FAILED_COMPARE_TOKEN = 'failed-compare-token'
export const LOADING_COMPARE_TOKEN = 'loading-compare-token'
export const LOADED_COMPARE_TOKEN = 'loaded-compare-token'
export const SET_COMPARE_MODELS = 'set-compare-models'
export const GET_UPLOAD_COMPARE_ID = 'get-upload-compare-id'
...
/* Upload Model Files Store Events */
...
export const SET_IS_VERSIONING = 'set-is-versioning'
...
/* Attachment File Upload Events */
export const UPLOAD_ATTACHMENT_FILES = 'upload-attachment-files'
