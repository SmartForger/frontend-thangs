...
const ToolbarTool = (props) => {
    ...
    const c = useStyles();
    return (<div id={tool} title={title} className={c.hoopsTool} onClick={onClick}>
        {children}
    </div>)
}
...
const DebugToolbar = ({
    ...
    return (
        <Toolbar>
            <ToolbarTool tool="home-button" title="Front View" onClick={makeNewValueOrientationHandler('Front')}>
                <HeartIcon />
            </ToolbarTool>

            <ToolbarTool tool="view-button" title="Back View" onClick={makeNewValueOrientationHandler('Back')} >
                <DownloadIcon />
            </ToolbarTool>
            <ToolbarTool tool="edgeface-button" title="Right View" onClick={makeNewValueOrientationHandler('Right')}>
                <PlusIcon />
            </ToolbarTool>

            <ToolbarTool tool="camera-button" title="Left View" onClick={makeNewValueOrientationHandler('Left')}>
                <UploadIcon />
            </ToolbarTool>
            <div id="explode-button" title="Explode Menu" className="hoops-tool toolbar-menu-toggle">
                <div className={c.toolIcon}></div>
            </div>
            <div id="cuttingplane-button" title="Cutting Plane Menu" className="hoops-tool toolbar-menu-toggle">
                <div className={c.toolIcon}></div>
            </div>
                ...
                <div id="redline-submenu" className="toolbar-submenu submenus">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <div id="redline-circle-button" title="Redline Circle" className={c.submenuIcon}></div>
                                </td>
                                <td>
                                    <div id="redline-rectangle-button" title="Redline Rectangle" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="redline-note" title="Redline Note" className={c.submenuIcon}></div>
                                </td>
                                <td>
                                    <div id="redline-freehand" title="Redline Freehand" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div id="camera-submenu" className="toolbar-submenu submenus">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <div id="operator-camera-walk" title="Walk" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="operator-camera-turntable" title="Turntable" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="operator-camera-orbit" title="Orbit Camera" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div id="edgeface-submenu" className="toolbar-submenu submenus">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <div id="viewport-wireframe-on-shaded" title="Shaded With Lines" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="viewport-shaded" title="Shaded" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div id="viewport-wireframe" title="Wireframe" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <div id="view-submenu" className="toolbar-submenu submenus">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <div id="view-face" title="Orient Camera To Selected Face" className="submenu-icon disabled"></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div id="view-ortho" title="Orthographic Projection" className={c.submenuIcon}></div>
                                </td>
                                <td>
                                    <div id="view-persp" title="Perspective Projection" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div id="view-bottom" title="Bottom View" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                ...
                <div id="click-submenu" className="toolbar-submenu submenus">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <div id="note-button" title="Create Note-Pin" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="measure-angle-between-faces" title="Measure Angle Between Faces" className={c.submenuIcon}></div>
                                </td>
                                <td>
                                    <div id="measure-distance-between-faces" title="Measure Distance Between Faces" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="measure-edges" title="Measure Edges" className={c.submenuIcon}></div>
                                </td>
                                <td>
                                    <div id="measure-point-to-point" title="Measure Point to Point" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="select-parts" title="Select Parts" className={c.submenuIcon}></div>
                                </td>
                                <td>
                                    <div id="area-select" title="Area Select" className={c.submenuIcon}></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div id="cuttingplane-submenu" className="toolbar-submenu cutting-plane submenus no-modal">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <div id="cuttingplane-face" title="Create Cutting Plane On Selected Face" className="toolbar-cp-plane submenu-icon disabled"></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="cuttingplane-x" title="Cutting Plane X" className="toolbar-cp-plane submenu-icon"></div>
                                </td>
                                <td>
                                    <div id="cuttingplane-section" title="Cutting Plane Visibility Toggle" className="toolbar-cp-plane submenu-icon disabled"></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="cuttingplane-y" title="Cutting Plane Y" className="toolbar-cp-plane submenu-icon"></div>
                                </td>
                                <td>
                                    <div id="cuttingplane-toggle" title="Cutting Plane Section Toggle" className="toolbar-cp-plane submenu-icon disabled"></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div id="cuttingplane-z" title="Cutting Plane Z" data-plane="z" className="toolbar-cp-plane submenu-icon"></div>
                                </td>
                                <td>
                                    <div id="cuttingplane-reset" title="Cutting Plane Reset" className="toolbar-cp-plane submenu-icon disabled"></div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
