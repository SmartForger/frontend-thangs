...
const ModelTitleStyled = styled(ModelTitle)`
    margin-bottom: 40px;
`;
...
const Page = () => {
    ...
    const { loading: modelLoading, error: modelError, model } = graphqlService.useModelById(parentModelId);
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <Row>
                    ...
                    <Column
                        ...
                        `}
                    >
                        {model && <ModelTitleStyled model={model} />}
                        <Field>
                            <ErrorMessage
                                errors={errors}
                                name="name"
...
const UploadVersion = WithNewThemeLayout(Page);
