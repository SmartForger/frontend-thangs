...
export const USER_GRANTED_USER_ACCESS_TO_FOLDER = 'USER_GRANTED_USER_ACCESS_TO_FOLDER'
...
export function useUserUnreadNotificationCount(id) {
  ...
  const unreadNotificationCount = data && data.user && data.user.unreadNotificationCount
